...
namespace GestureControls.Controls
{
    public class MagnetButton : HoverButton
    {
        ...
        protected override void OnKinectCursorEnter(object sender, KinectCursorEventArgs e)
        {
            ...
            {
                this.RaiseEvent(new KinectCursorEventArgs(KinectCursorLockEvent, new Point(x + LockXOffsetFromCenter, y + LockYOffsetFromCenter), e.Z) { KinectCursor = e.KinectCursor });
            };

            if (move != null)
                move.Stop(e.KinectCursor);
        ...
        protected override void OnKinectCursorLeave(object sender, KinectCursorEventArgs e)
        {
            ...
            e.KinectCursor.UpdateCursor(new Point(e.X, e.Y), false);
            ...
            move.Completed += delegate
            {
                ...
                this.RaiseEvent(new KinectCursorEventArgs(KinectCursorUnlockEvent, new Point(e.X, e.Y), e.Z) { KinectCursor = e.KinectCursor });
            };
        ...
        {
            this.RaiseEvent(new KinectCursorEventArgs(KinectCursorUnlockEvent, new Point(_lastPointDetected.X, _lastPointDetected.Y), _lastPointDetected.Z) { KinectCursor = _lastPointDetected.KinectCursor });
        }

        protected override void OnKinectCursorActivate(object sender, RoutedEventArgs e)
        {
            this.RaiseEvent(new KinectCursorEventArgs(KinectCursorEnterEvent, new Point(_lastPointDetected.X, _lastPointDetected.Y), _lastPointDetected.Z) { KinectCursor = _lastPointDetected.KinectCursor });
        }
